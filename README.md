...
- **New UI** — refreshed screens and layout for a cleaner, more consistent look
- **React Native CLI** — app is now built with the React Native CLI (not Expo), for full native Android control and release builds

## What's new in v0.0.2

- **Forgot password** — reset your password from the login screen
- **Email OTP** — receive a one-time code by email to verify the reset
- **Reset API wiring** — request OTP, verify code, and set a new password end-to-end
